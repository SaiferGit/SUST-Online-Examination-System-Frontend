    ...
    return (
        <div class="formClass">
            <form>
                ...
                <br/>
                <input class= "inputBox" type="text" style={{width:'400px'}} placeholder="201xxxxxxx"/>
                <br/>
                <br/>
                ...
                <Link to="/student/dashboard"><button style={{height:'45px', width:'150px', fontSize:'large'}} className="main-button" >Proceed 
