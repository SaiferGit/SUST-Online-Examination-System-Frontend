    ...
    return (
        <div className="sidebar-list">
            <ul>
                ...
                <li className={activePage.myExam && 'activePage'}><Link to={"/student/"+pages.myExam} onClick={handleMyExam}><AssignmentTurnedInIcon />My Exams</Link></li>
                
                <li className={activePage.result && 'activePage'}><Link to={"/student/"+pages.result} onClick={handleResult}><PollIcon /> Results</Link></li>
                
                <li className={activePage.assignment && 'activePage'}><Link to={"/student/"+pages.assignment} onClick={handleAssigntment}><ClassIcon/> Assignments</Link></li>
            </ul>
        </div>
    );
};
