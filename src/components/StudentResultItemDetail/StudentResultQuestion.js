...
const StudentResultQuestion = (props) => {
    ...
    return (
        <div style={{padding:'5px 10px',marginTop:'20px'}} className="questionresult-item d-flex justify-content-between align-items-center">
            <div>
                <p id="questions">{props.index+1}. {name}</p>
            </div>
