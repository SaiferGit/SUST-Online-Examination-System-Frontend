            ...
            <div className="dashboard-items">
                <div className="dashboard-next-exam d-flex justify-content-between">
                    ...
                    <div style={{display:'flex'}}>
                        <h1 style={{color:'white',marginTop:'5%',marginRight:'20px'}}>12:00AM</h1>

                        <Link to="/student/runningexam">
                            <button className="main-button">Enter Now <img style={{height:'23px', width:'23px', marginTop:'-2px'}}  src={rightArrow}alt=""/>
                            </button>
                        </Link>
                    </div>
                </div>
