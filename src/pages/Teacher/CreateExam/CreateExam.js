...
const CreateExam = () => {
    ...
    console.log(hide);
    return (
        <div style={{margin:'2vw', marginTop:'-70px'}} >
            <div className={hide && 'hide'}>
                ...
                <form>
                    <div className="form-group">
                        ...
                        <input class={"form-group-input"} style={{marginTop:'-7px'}} type="text" placeholder="Exam title"/>
                    </div>
                    <div className="form-group">
                        <label  class="labelText" >Description</label>
                        <textarea class={"form-group-input"} style={{marginTop:'-7px'}} rows="5"></textarea>
                    </div>
                    <label style={{marginTop:'-7px'}}  class="labelText">Date & Time</label>
                        
                    <div class={"divdatepicker"} style={{marginTop:'-7px'}}>
                        <DatePicker style={{marginTop:'-7px', width:'35vw'}}
                            selected={startDate}
